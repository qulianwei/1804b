...
<!-- 引入ztree的css -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/js/ztree/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
...
<!-- ztree的js -->
<%-- <script type="text/javascript" src="<%=request.getContextPath()%>/js/ztree/zTree/js/jquery-1.4.4.min.js"></script>
 --%><script type="text/javascript" src="<%=request.getContextPath()%>/js/ztree/zTree/js/jquery.ztree.core.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/ztree/zTree/js/jquery.ztree.exedit.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/ztree/zTree/js/jquery.ztree.excheck.js"></script>
